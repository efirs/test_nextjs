...
// GET /api/product/[id] -- gets document from collection where id = [id]
// PUT /api/product/[id] { Product } -- updates the document in collection where id = [id]
// DELETE /api/product/[id] -- deletes the document in collection where id = [id]
